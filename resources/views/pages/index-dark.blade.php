    ...
    <div class="page-wrapper">
        ...
        <section class="mail-one">
            ...
            <div class="mail-one__shape-left"
                style="background-image: url(assets/images/resources/mail-shape-1.png);"></div>
            <div class="mail-one__shape-right"
                style="background-image: url(assets/images/resources/mail-shape-2.png);"></div>
            <div class="mail-one__overlay" style="background-image: url(assets/images/shapes/mail-1-bg-overlay.png);">
            </div>
            <div class="container">
