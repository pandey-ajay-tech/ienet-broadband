    ...
    <div class="page-wrapper">
                    ...
                    <div class="main-slider-one__item">
                        ...
                        <div class="main-slider-one__content">
                            ...
                            <div class="main-slider-one__btn">
                                <a href="services" class="ienet-btn main-slider-one__btn__first"><span>our
                                        service<span class="ienet-btn__icon"><i
                                                class="fas fa-chevron-left"></i></span></span></a><!-- slider-btn -->
                        ...
                        <div class="main-slider-one__layer"
                            style="background-image: url(assets/images/backgrounds/slider-1-layer-1-rtl.png);"></div>
                    </div>
                </div>
                <div class="item">
                    <div class="main-slider-one__item">
                        ...
                        <div class="main-slider-one__layer"
                            style="background-image: url(assets/images/backgrounds/slider-1-layer-2-rtl.png);"></div>
                    </div>
                </div>
                <div class="item">
                    <div class="main-slider-one__item">
                        ...
                        <div class="main-slider-one__layer"
                            style="background-image: url(assets/images/backgrounds/slider-1-layer-3-rtl.png);"></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="about-one" style="background-image: url(assets/images/shapes/about-1-bg.png);">
            <div class="about-one__shape"
                style="background-image: url(assets/images/resources/about-shape-1-rtl.png);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="about-one__image wow fadeInLeft" data-wow-delay="300ms">
                            ...
                            <div class="about-one__image__two">
                                <div class="about-one__image__two__inner"><img
                                        src="assets/images/resources/about-1-2.jpg" alt="ienet"></div>
                            </div>
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="300ms">
                        <div class="about-one__content">
                            ...
                            <a href="about" class="ienet-btn"><span>More About Us<span class="ienet-btn__icon"><i
                                            class="fas fa-chevron-left"></i></span></span></a>
                        ...
                        <div class="row gutter-y-30">
                            <div class="col-lg-4 col-md-6">
                                <div class="packages-one__card">
                                    ...
                                    <a class="packages-one__card__rm" href="contact"><i
        ...
        <section class="mail-one">
            ...
            <div class="mail-one__shape-left"
                style="background-image: url(assets/images/resources/mail-shape-1-rtl.png);"></div>
            <div class="mail-one__shape-right"
                style="background-image: url(assets/images/resources/mail-shape-2-rtl.png);"></div>
            <div class="container">
        ...
        <section class="faq-one">
            <div class="faq-one__shape" style="background-image: url(assets/images/resources/faq-shape-1.png);">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
        ...
        <section class="testimonials-one">
            <div class="testimonials-one__bg"
                style="background-image: url(assets/images/shapes/testimonial-bg-1.png);"></div>
                    ...
                    <div class="col-xl-6">
                        <div class="testimonials-one__content">
                            ...
                            <div class="testimonials-one__nav">
                                <a href="#" class="testimonials-one__nav__prev"><i
                                        class="icon-right-chevron"></i></a>
                                <a href="#" class="testimonials-one__nav__next"><i
				...
				"992": {
                    ...
                    <div class="item">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            ...
                            <div class="blog-card__content">
                                <h3 class="blog-card__title"><a href="blog-details-right">Cupidatat Nonproident,
                        ...
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            <div class="blog-card__image">
                                ...
                                <img src="assets/images/blog/blog-1-2.png"
                                    alt="The Best Usage of The Fiber Internet from Broadband">
                                <a href="blog-details-right" class="blog-card__image__link"><span
                                        class="sr-only">The Best Usage of The Fiber Internet from Broadband</span>
                                    <!-- /.sr-only --></a>
                                <div class="blog-card__date">AUG, 04</div><!-- /.blog-card__date -->
                                <ul class="list-unstyled blog-card__meta">
                                    <li><a href="blog-list-right"><i class="fas fa-user-alt"></i>by Admin</a></li>
                            ...
                            <div class="blog-card__content">
                                <h3 class="blog-card__title"><a href="blog-details-right">The Best Usage of The
                                        Fiber Internet from Broadband</a></h3><!-- /.blog-card__title -->
                                <a href="blog-details-right" class="blog-card__link">
                                    <span class="blog-card__link__front"><span
                                            class="fas fa-angle-double-right"></span></span>
                                    <span class="blog-card__link__back"><span
                    ...
                    <div class="item">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                            ...
                            <div class="blog-card__content">
                                <h3 class="blog-card__title"><a href="blog-details-right">Suspendisse Posuere, Leo
                                        ac Laoreet Dapibus, Urna</a></h3><!-- /.blog-card__title -->
                                <a href="blog-details-right" class="blog-card__link">
                                    <span class="blog-card__link__front"><span
                                            class="fas fa-angle-double-right"></span></span>
                                    <span class="blog-card__link__back"><span
