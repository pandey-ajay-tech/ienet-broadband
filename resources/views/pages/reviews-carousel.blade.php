...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="testimonials-one testimonials-one--page">
            <div class="container">
                <div class="testimonials-one__carousel ienet-owl__carousel ienet-owl__carousel--with-shadow ienet-owl__carousel--basic-nav owl-carousel owl-theme"
                    data-owl-options='{
				"items": 1,
				"margin": 30,
				"loop": false,
                    ...
                    <div class="item">
                        <div class="testimonials-card wow fadeInUp" data-wow-duration='1500ms'
                            ...
                            <div class="testimonials-card__content">
                                Ienet internet Company also impressed us with their transparency regarding costs. The
                                initial quote was accurate,
