...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="team-one">
            <div class="container">
                <div class="team-one__carousel ienet-owl__carousel ienet-owl__carousel--with-shadow ienet-owl__carousel--basic-nav owl-carousel owl-theme"
                    data-owl-options='{
				"items": 1,
				"margin": 0,
				"loop": false,
				...
				"responsive": {
                    ...
                    <div class="item">
                        <div class="team-one__item wow fadeInUp" data-wow-delay="00ms"
                            style="--accent-color: #DF2339;">
                            <div class="team-one__item__shape"
                                style="background-image: url(assets/images/shapes/team-1-shape-1.png);"></div>
                            ...
                            <div class="team-one__item__content">
                                ...
                                <h3 class="team-one__item__title">
                                    <a href="team-details">Andrey Khusid</a>
                                </h3><!-- /.team-one__item__title -->
                                <p class="team-one__item__designation">CEO and Co-founder</p>
                                <!-- /.team-one__item__designation -->
                            </div><!-- /.team-card__content -->
                        </div><!-- /.team-one__item -->
                    </div><!-- /.item -->
                    <div class="item">
                        <div class="team-one__item team-one__item--two wow fadeInUp" data-wow-delay="50ms"
                            style="--accent-color: #FEBE57;">
                            <div class="team-one__item__shape"
                                style="background-image: url(assets/images/shapes/team-1-shape-2.png);"></div>
                            <div class="team-one__item__image">
                            ...
                            <div class="team-one__item__content">
                                ...
                                <h3 class="team-one__item__title">
                                    <a href="team-details">Anna Boyarkina</a>
                                </h3><!-- /.team-one__item__title -->
                                <p class="team-one__item__designation">Head of Product</p>
                                <!-- /.team-one__item__designation -->
                            </div><!-- /.team-card__content -->
                        </div><!-- /.team-one__item -->
                    </div><!-- /.item -->
                    <div class="item">
                        <div class="team-one__item team-one__item--three wow fadeInUp" data-wow-delay="100ms"
                            style="--accent-color: #FF651F;">
                            <div class="team-one__item__shape"
                                style="background-image: url(assets/images/shapes/team-1-shape-3.png);"></div>
                            <div class="team-one__item__image">
                            ...
                            <div class="team-one__item__content">
                                ...
                                <h3 class="team-one__item__title">
                                    <a href="team-details">Eliana D Cruz</a>
                                </h3><!-- /.team-one__item__title -->
                                <p class="team-one__item__designation">Manager</p>
                                <!-- /.team-one__item__designation -->
                            </div><!-- /.team-card__content -->
                        </div><!-- /.team-one__item -->
                    </div><!-- /.item -->
                    <div class="item">
                        <div class="team-one__item team-one__item--four wow fadeInUp" data-wow-delay="150ms"
                            style="--accent-color: #4FA9C6;">
                            <div class="team-one__item__shape"
                                style="background-image: url(assets/images/shapes/team-1-shape-4.png);"></div>
                            <div class="team-one__item__image">
                            ...
                            <div class="team-one__item__content">
                                ...
                                <h3 class="team-one__item__title">
                                    <a href="team-details">Ronald C. Clark</a>
                                </h3><!-- /.team-one__item__title -->
                                <p class="team-one__item__designation">CEO and Co-founder</p>
                                <!-- /.team-one__item__designation -->
                            </div><!-- /.team-card__content -->
                    ...
                    <div class="item">
                        <div class="team-one__item team-one__item--five wow fadeInUp" data-wow-delay="200ms"
                            style="--accent-color: #F1CB40;">
                            <div class="team-one__item__shape"
                                style="background-image: url(assets/images/shapes/team-1-shape-5.png);"></div>
                            <div class="team-one__item__image">
                            ...
                            <div class="team-one__item__content">
                                ...
                                <h3 class="team-one__item__title">
                                    <a href="team-details">Ella L. Albers</a>
                                </h3><!-- /.team-one__item__title -->
                                <p class="team-one__item__designation">Head of Product</p>
                                <!-- /.team-one__item__designation -->
                            </div><!-- /.team-card__content -->
                    ...
                    <div class="item">
                        <div class="team-one__item team-one__item--six wow fadeInUp" data-wow-delay="250ms"
                            style="--accent-color: #E4E8EF;">
                            <div class="team-one__item__shape"
                                style="background-image: url(assets/images/shapes/team-1-shape-6.png);"></div>
                            <div class="team-one__item__image">
                            ...
                            <div class="team-one__item__content">
                                ...
                                <h3 class="team-one__item__title">
                                    <a href="team-details">Ben D. Reno</a>
                                </h3><!-- /.team-one__item__title -->
                                <p class="team-one__item__designation">Manager</p>
                                <!-- /.team-one__item__designation -->
                            </div><!-- /.team-card__content -->
