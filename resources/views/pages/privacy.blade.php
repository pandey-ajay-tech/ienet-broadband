...
@section('content')
    ...
    <!-- <section class="page-header">
        ...
        <div class="container">
            <h2 class="page-header__title bw-split-in-left">PRIVACY POLICY</h2>
            ...
            <div class="row gutter-y-60">
                ...
                <div class="col-md-12 col-lg-8">
                    <div class="service-details__content">
                        ...
                        <!-- Privacy Card 1 -->
                        <div class="privacy-card mb-4 p-4 rounded shadow"
                            style="background-color:#fff; border-left: 5px solid #e60000;">
                            <h3 class="service-details__title text-dark">Privacy Policy</h3>
                        ...
                        <!-- Privacy Card 2 -->
                        <div class="privacy-card mb-4 p-4 rounded shadow position-relative"
                ...
                background: linear-gradient(to bottom, #e60000, #ff4d4d); border-radius:8px 0 0 8px;">
                            ...
                            <ul style="list-style:none; padding-left:0; margin:0; position:relative; z-index:1;">
                                <li style="margin-bottom:15px; display:flex; align-items:flex-start;">
                                    ...
                                    <span style="color:#000; font-size:15px; line-height:1.6;">
                                        We collect personal information such as name, email, and contact details when
                                ...
                                <li style="margin-bottom:15px; display:flex; align-items:flex-start;">
                                    ...
                                    <span style="color:#000; font-size:15px; line-height:1.6;">
                                        We also gather non-personal information through cookies and analytics tools for
                                        website improvement.
                                    </span>
                                </li>
                            </ul>
                        ...
                        <div class="privacy-card mb-4 p-4 rounded shadow"
                            style="background-color:#fff; border-left: 5px solid #e60000;">
                            <h3 class="service-details__title text-dark">Information Usage</h3>
                            <p class="service-details__text text-dark">
                                Collected information is used to provide services, improve user experience, and communicate
                        ...
                        <div class="privacy-card mb-4 p-4 rounded shadow"
                            style="background-color:#fff; border-left: 5px solid #e60000;">
                            <h3 class="service-details__title text-dark">Data Security</h3>
                            <p class="service-details__text text-dark">
                                We implement appropriate security measures to protect personal data from unauthorized
                                access,
                        ...
                        <div class="privacy-card mb-4 p-4 rounded shadow"
                            style="background-color:#fff; border-left: 5px solid #e60000;">
                            <h3 class="service-details__title text-dark">Policy Updates</h3>
                            <p class="service-details__text text-dark">
                                This Privacy Policy may change over time. We encourage users to periodically review this
                                page
                                for updates. Continued use of the website signifies acceptance of any changes.
                            </p>
                        </div>
