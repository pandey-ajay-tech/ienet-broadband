...
<head>
    ...
    <title>Fast Internet & Cyber Security || Services Details || Ienet || HTML Template For Broadband TV & Internet
    </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-left">Fast Internet & Cyber Security</h2>
                <!-- /.page-title -->
                    ...
                    <div class="col-md-12 col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__thumbnail">
                                <img src="assets/images/resources/service-d-3.jpg"
                                    alt="Fast Internet & Cyber Security Activation">
                            </div><!-- /.service-details__thumbnail -->
                            <h3 class="service-details__title">Fast Internet & Cyber Security Activation</h3>
                            ...
                            <p class="service-details__text">
                                ...
                                Phasellus eget ligula leo. Donec ex eros, tristique ac sollicitudin eu, congue id sem.
                                Sed sit amet elementum velit, lacinia
                            ...
                            <h3 class="service-details__title">Benefit of This Service</h3>
                            <!-- /.service-details__title -->
                            <p class="service-details__text">
                                onsectetur dui vitae convallis. Aliquam posuere vitae enim vitae pulvinar. Pellentesque
                                sit amet luctus ante, ut elementum nisl.
                        ...
                        <div class="service-sidebar">
                            <div class="service-sidebar__single">
                                <ul class="list-unstyled service-sidebar__nav">
                                    <li><a href="service-d-broadband">Fiber Line & Broadband Line</a></li>
                                    <li><a href="service-d-iptv">Fiber Line With Smart IPTV</a></li>
                                    <li><a href="service-d-cyber-security">Fast Internet & Cyber Security</a></li>
                                    <li><a href="service-d-landline">Optical Fiber & Landline</a></li>
                                    <li><a href="service-d-tv">Amazon Fire Stick Box TV</a></li>
                                    <li><a href="service-d-connectivity">Smart Data Connectivity Line</a></li>
