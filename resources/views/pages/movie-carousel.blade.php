...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="movie-one movie-one--page">
            <div class="container">
                <div class="movie-one--page__carousel ienet-owl__carousel ienet-owl__carousel--basic-nav owl-carousel owl-theme"
                    data-owl-options='{
				"items": 1,
				"margin": 30,
				"loop": false,
				...
				"responsive": {
                    ...
                    <div class="item">
                        <div class="movie-one__item">
                            ...
                            <div class="movie-one__item__content">
                                <h3 class="movie-one__item__title"><a href="movie-details">The Venom Carnage</a></h3>
                                <ul class="movie-one__item__list">
                                    <li><i class="fa fa-star"></i>6.8(Imdb)</li>
                                    <li>1hr : 30mins</li>
                                </ul>
        ...
        <section class="video-one">
            <div class="video-one__bg jarallax" data-jarallax data-speed="0.3" data-imgPosition="50% -100%"
                style="background-image: url(assets/images/backgrounds/video-bg-1.jpg);"></div>
            <!-- /.movie-one__bg -->
            <div class="container">
                <a href="https://www.youtube.com/watch?v=h9MbznbxlLc" class="video-popup">
                    <i class="fa fa-play"></i>
