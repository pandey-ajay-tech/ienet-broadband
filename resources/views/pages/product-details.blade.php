                    ...
                    <div class="col-lg-6 col-xl-6 d-flex align-items-center wow fadeInRight" data-wow-delay="300ms">
                        <div class="product-details__content">
                            ...
                            <div class="product-details__buttons">
                                <a href="cart.html" class="ienet-btn product-details__buttons__cart"><span>Add To Cart<span class="ienet-btn__icon"><i class="icon-cart"></i></span></span></a>
                                <a href="checkout.html" class="ienet-btn product-details__buttons__wishlist"><span>Add to Wishlist</span></a>
                            </div><!-- /.qty-btn -->
