        ...
        <section class="team-details">
            <div class="container">
                <div class="team-details__inner">
                    <div class="team-details__inner__bg"
                        style="background-image: url(assets/images/shapes/team-details-inner-bg.png);"></div>
                    <div class="row gutter-y-30">
                        <div class="col-lg-4">
                            <div class="team-details__image">
                                <img src="assets/images/team/team-d-1.png"
                                    alt="aleesha Brown Beauty Expert & Therapist">
                        ...
                        <div class="col-lg-8">
                            <div class="team-details__content">
                                ...
                                <p class="team-details__text">
                                    onsectetur dui vitae convallis. Aliquam posuere vitae enim vitae pulvinar.
                                    Pellentesque sit amet luctus ante,
                                    ut elementum nisl. Ut at ornare dui. In cursus hendrerit pulvinar. Sed consectetur
                                    elit leo. Curabitur
                                    pellentesque ultrices odio eu pellentesque. Phasellus eget ligula leo. Donec ex
                                    eros, tristique ac
                                    sollicitudin eu, congue id sem. Sed sit amet elementum velit, lacinia sollicitudin
                                    dolor.
                                </p>
                                <p class="team-details__text">
                                    as well as a board member of their software subsidiary. He is also an avid cook and
                                    history buff. You can find him
                                ...
                                <ul class="list-unstyled team-details__list">
                                    <li>
                                        <div class="team-details__list__icon"><span class="icon-telephone"></span>
                                        </div>
                                    ...
                                    <li>
                                        <div class="team-details__list__icon"><span
                                                class="icon-maps-and-flags"></span></div>
        ...
        <section class="team-details-info">
            <div class="container">
                ...
                <p class="team-details-info__text">
                    onsectetur dui vitae convallis. Aliquam posuere vitae enim vitae pulvinar. Pellentesque sit amet
                    luctus ante, ut elementum nisl.
                    Ut at ornare dui. In cursus hendrerit pulvinar. Sed consectetur elit leo. Curabitur pellentesque
                    ultrices odio eu pellentesque.
                    Phasellus eget ligula leo. Donec ex eros, tristique ac sollicitudin eu, congue id sem. Sed sit amet
                    elementum velit, lacinia
                    sollicitudin dolor.
                ...
                <div class="team-details-info__area">
                    ...
                    <p class="team-details-info__text">
                        ...
                        Ut at ornare dui. In cursus hendrerit pulvinar. Sed consectetur elit leo. Curabitur pellentesque
                        ultrices odio eu pellentesque.
                        Phasellus eget ligula leo. Donec ex eros, tristique ac sollicitudin eu, congue id sem. Sed sit
                        amet elementum velit, lacinia
                        sollicitudin dolor.
                    </p><!-- /.team-details-info__text -->
                </div>
            </div><!-- /.container -->
