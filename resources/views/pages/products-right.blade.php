                        ...
                        <div class="row gutter-y-30">
                            <div class="col-md-6 col-lg-4">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms'
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details">Digital Brush</a>
                                        </h4><!-- /.product-title -->
                                        <div class="product__item__price">$20.00</div><!-- /.product-price -->
                                        <a href="cart" class="ienet-btn product__item__link"><span>Add To Cart<span
                                                    class="ienet-btn__icon"><i
                                                        class="icon-cart"></i></span></span></a>
                                    </div><!-- /.product-content -->
                                </div><!-- /.product-item -->
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms'
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details">Tplink Router</a>
                                        </h4><!-- /.product-title -->
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms'
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details">Digital Camera</a>
                                        </h4><!-- /.product-title -->
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms'
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details">Awesome VR</a></h4>
                                        <!-- /.product-title -->
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms'
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details">Digital Mic</a>
                                        </h4><!-- /.product-title -->
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms'
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details">Wifi Gadget</a>
                                        </h4><!-- /.product-title -->
                            ...
                            <div class="col-md-12">
                                <ul class="post-pagination text-center product__pagination">
                                    <li><a href="products-right"><i class="icon-arrow-point-to-left"></i></a></li>
                                    <li><a class="current" href="products-right">01</a></li>
                                    <li><a href="products-right">02</a></li>
                                    <li><a href="products-right">03</a></li>
                                    <li><a href="products-right"><i class="icon-arrow-point-to-right"></i></a></li>
                                </ul>
                            </div><!-- /.col-md-12 -->
                        </div><!-- /.row -->
                    </div><!-- /.col-lg-9 -->
                        ...
                        <div class="product__sidebar">
                            ...
                            <div class="product__categories">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="products"><span class="icon-arrow-point-to-right"></span>Kitchen
                                            Faucet</a></li>
                                    <li><a href="products"><span class="icon-arrow-point-to-right"></span>Toilet
                                            Bowl</a></li>
                                    <li><a href="products"><span class="icon-arrow-point-to-right"></span>Pipe
                                            Elbows</a></li>
                                    <li><a href="products"><span class="icon-arrow-point-to-right"></span>Pressure
                                            Reducing</a></li>
                                    <li><a href="products"><span class="icon-arrow-point-to-right"></span>Water
                                            Softeners</a></li>
                                </ul>
                            </div><!-- /.category-widget -->
                        </div><!-- /.shop-sidebar -->
