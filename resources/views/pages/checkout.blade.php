                                ...
                                <div class="row bs-gutter-x-30">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="checkout-page__input-box">
                                            ...
                                            <input type="text" id="address_one" name="address_one" value=""
                                    ...
                                    <div class="col-xl-6">
                                        <div class="checkout-page__input-box">
                                            ...
                                            <input type="text" id="address_two" name="address_two" value=""
                                                placeholder="1837 E Homer M Adams Pkwy" required="">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="checkout-page__input-box">
                                            ...
                                            <select class="selectpicker" id="country_area"
                                                aria-label="Default select example">
                        ...
                        <div class="col-lg-6">
                            <div class="checkout-page__payment">
                                ...
                                <div class="checkout-page__payment__btn">
                                    <a href="checkout" class="ienet-btn">
