...
<head>
    ...
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/logo_wifi.png" />
                            ...
                            <form class="login-page__form">
                                ...
                                <div class="login-page__form-check-wrapper">
                                    ...
                                    <div class="login-page__form-forgot-password">
                                        <a href="login">Forgot your Passowrd?</a>
                                    </div>
                                </div>
                                <div class="login-page__form-btn-box">
                                    ...
                                    <a href="login" class="ienet-btn login-page__form-btn-box__google"><span><img
                                                src="assets/images/shapes/google.png" alt="ienet">Or sign in with
                                            Google</span></a>
                                    <p class="login-page__form-btn-box__register-text">Don’t have an account? <a
                                            href="login">Sign up now</a></p>
                                </div>
                            </form>
                        </div><!-- register-form -->
                    </div>
        ...
        <div class="mobile-nav__content">
            ...
            <ul class="mobile-nav__contact list-unstyled">
                ...
                <li>
                    ...
                    <a href="tel:666-888-0000">9234377577</a>
                </li>
