                        ...
                        <div class="login-page__wrap">
                            ...
                            <form class="login-page__form">
                                ...
                                <div class="login-page__form-btn-box">
                                    ...
                                    <a href="login.html" class="ienet-btn login-page__form-btn-box__google"><span><img src="assets/images/shapes/google.png" alt="ienet">Or sign in with Google</span></a>
                                    <p class="login-page__form-btn-box__register-text">Don’t have an account? <a href="login.html">Sign up now</a></p>
                                </div>
                            </form>
                        </div><!-- register-form -->
                    </div>
