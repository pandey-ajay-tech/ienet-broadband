                    ...
                    <div class="main-slider-one__item">
                        ...
                        <div class="main-slider-one__content">
                            ...
                            <div class="main-slider-one__btn">
                                <a href="services.html" class="ienet-btn main-slider-one__btn__first"><span>our service<span class="ienet-btn__icon"><i class="fas fa-chevron-right"></i></span></span></a><!-- slider-btn -->
                                <a href="packages.html" class="ienet-btn main-slider-one__btn__last"><span><span class="ienet-btn__icon ienet-btn__icon--left"><i class="fas fa-gem"></i></span>browse plan</span></a><!-- slider-btn -->
                            </div>
                        </div>
                        <div class="main-slider-one__image">
                            <div class="main-slider-one__image__one">
                                <img src="{{asset('assets/images/backgrounds/slider-1-layer-2.jpg')}}" alt="ienet">
                            </div>
                            <div class="main-slider-one__image__border">
                                <img src="{{asset('assets/images/shapes/slider-1-border.png')}}" alt="ienet">
                            </div>
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__image wow fadeInLeft" data-wow-delay="300ms">
                            ...
                            <div class="about-one__image__two">
                                <div class="about-one__image__two__inner"><img src="{{asset('assets/images/resources/about-1-2.jpg')}}" alt="ienet"></div>
                            </div>
        ...
        <section class="packages-one">
            ...
            <div class="container tabs-box">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="packages.html" class="ienet-btn"><span>View All Service<span class="ienet-btn__icon"><i class="fas fa-chevron-right"></i></span></span></a>
                    </div>
                </div>
                        ...
                        <div class="row gutter-y-30">
                            <div class="col-lg-4 col-md-6">
                                <div class="packages-one__card">
                                    ...
                                    <a class="packages-one__card__rm" href="contact.html"><i class="icon-right-chevron"></i></a>
                                ...
                                <div class="item">
                                    <div class="testimonials-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                                        ...
                                        <div class="testimonials-card__author">
                                            <img src="{{asset('assets/images/resources/testi-1-1.jpg')}}" alt="Anthony B. Castillo">
				...
				"992": {
                    ...
                    <div class="item">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="blog-card__image">
                                <img src="{{asset('assets/images/blog/blog-1-1.png')}}" alt="Cupidatat Nonproident, Sunt in Culpa qui Officia Deserunt">
                                <img src="{{asset('assets/images/blog/blog-1-1.png')}}" alt="Cupidatat Nonproident, Sunt in Culpa qui Officia Deserunt">
                    ...
                    <div class="item">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            <div class="blog-card__image">
                                <img src="{{asset('assets/images/blog/blog-1-2.png')}}" alt="The Best Usage of The Fiber Internet from Broadband">
                                <img src="{{asset('assets/images/blog/blog-1-2.png')}}" alt="The Best Usage of The Fiber Internet from Broadband">
                    ...
                    <div class="item">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                            <div class="blog-card__image">
                                <img src="{{asset('assets/images/blog/blog-1-3.png')}}" alt="Suspendisse Posuere, Leo ac Laoreet Dapibus, Urna">
                                <img src="{{asset('assets/images/blog/blog-1-3.png')}}" alt="Suspendisse Posuere, Leo ac Laoreet Dapibus, Urna">
            ...
            "responsive":{
                ...
                "1200":{
                    ...
                    <div class="client-carousel__one__item">
                        <img class="client-carousel__one__item__normal" src="{{asset('assets/images/resources/brand-1-1.png')}}" alt="ienet">
                        <img class="client-carousel__one__item__hover" src="{{asset('assets/images/resources/brand-1-1-hover.png')}}" alt="ienet">
                    </div><!-- /.owl-slide-item-->
                    <div class="client-carousel__one__item">
                        <img class="client-carousel__one__item__normal" src="{{asset('assets/images/resources/brand-1-2.png')}}" alt="ienet">
                        <img class="client-carousel__one__item__hover" src="{{asset('assets/images/resources/brand-1-2-hover.png')}}" alt="ienet">
                    </div><!-- /.owl-slide-item-->
                    <div class="client-carousel__one__item">
                        <img class="client-carousel__one__item__normal" src="{{asset('assets/images/resources/brand-1-3.png')}}" alt="ienet">
                        <img class="client-carousel__one__item__hover" src="{{asset('assets/images/resources/brand-1-3-hover.png')}}" alt="ienet">
                    </div><!-- /.owl-slide-item-->
                    <div class="client-carousel__one__item">
                        <img class="client-carousel__one__item__normal" src="{{asset('assets/images/resources/brand-1-4.png')}}" alt="ienet">
                        <img class="client-carousel__one__item__hover" src="{{asset('assets/images/resources/brand-1-4-hover.png')}}" alt="ienet">
                    </div><!-- /.owl-slide-item-->
                    <div class="client-carousel__one__item">
                        <img class="client-carousel__one__item__normal" src="{{asset('assets/images/resources/brand-1-5.png')}}" alt="ienet">
                        <img class="client-carousel__one__item__hover" src="{{asset('assets/images/resources/brand-1-5-hover.png')}}" alt="ienet">
                    </div><!-- /.owl-slide-item-->
                </div><!-- /.thm-owl__slider -->
            </div><!-- /.container -->
        </div><!-- /.client-carousel -->
