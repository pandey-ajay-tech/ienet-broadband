            ...
            <div class="row">
                ...
                <div class="col-xl-6 wow fadeInRight" data-wow-delay="300ms">
                    <div class="about-one__content">
                        ...
                        <a href="about.html" class="ienet-btn"><span>More About Us<span class="ienet-btn__icon"><i
    ...
    <section class="packages-one">
        ...
        <div class="container tabs-box">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <a href="packages.html" class="ienet-btn"><span>View All Service<span class="ienet-btn__icon"><i
                                    class="fas fa-chevron-right"></i></span></span></a>
                </div>
            </div>
                    ...
                    <div class="row gutter-y-30">
                        <div class="col-lg-4 col-md-6">
                            <div class="packages-one__card">
                                ...
                                <a class="packages-one__card__rm" href="contact.html"><i
			...
			"responsive": {
                    ...
                    <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                        <div class="blog-card__image">
                            ...
                            <a href="blog-details-right.html" class="blog-card__image__link"><span
                                    class="sr-only">Cupidatat Nonproident, Sunt in Culpa qui Officia Deserunt</span>
                                <!-- /.sr-only --></a>
                        ...
                        <div class="blog-card__content">
                            <h3 class="blog-card__title"><a href="blog-details-right.html">Cupidatat Nonproident, Sunt in
                                    Culpa qui Officia Deserunt</a></h3><!-- /.blog-card__title -->
                ...
                <div class="item">
                    <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                        <div class="blog-card__image">
                            ...
                            <img src="{{ asset('assets/images/blog/blog-1-2.png') }}"
                                alt="The Best Usage of The Fiber Internet from Broadband">
                            <a href="blog-details-right.html" class="blog-card__image__link"><span class="sr-only">The
                        ...
                        <div class="blog-card__content">
                            <h3 class="blog-card__title"><a href="blog-details-right.html">The Best Usage of The Fiber
                ...
                <div class="item">
                    <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                        ...
                        <div class="blog-card__content">
                            <h3 class="blog-card__title"><a href="blog-details-right.html">Suspendisse Posuere, Leo ac
